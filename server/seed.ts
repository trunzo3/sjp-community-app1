...
export async function seedDatabase() {
  ...
  const seedUsers = [
    { email: "angela@sjp.demo", password: hash, firstName: "Angela", lastName: "Torres", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#4CAF50", bio: "Just started at Gateway. Taking it one day at a time." },
    { email: "keisha@sjp.demo", password: hash, firstName: "Keisha", lastName: "Williams", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#FF9800", bio: "Two weeks in. Already learning so much." },
    { email: "destiny@sjp.demo", password: hash, firstName: "Destiny", lastName: "Johnson", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#2196F3", bio: "Working on my future every day. Moved to OSS last month." },
    { email: "maria@sjp.demo", password: hash, firstName: "Maria", lastName: "Garcia", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#9C27B0", bio: "Kitchen team and loving it. Getting ready for what's next." },
    { email: "monica@sjp.demo", password: hash, firstName: "Monica", lastName: "Davis", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(monicaGrad), avatarColor: "#E91E63", bio: "Working full-time at Golden 1 Center. My kids are home with me." },
    { email: "tasha@sjp.demo", password: hash, firstName: "Tasha", lastName: "Robinson", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(tashaGrad), avatarColor: "#00BCD4", bio: "Just started my new customer service role. Grateful every day." },
    { email: "denise@sjp.demo", password: hash, firstName: "Denise", lastName: "Mitchell", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(deniseGrad), avatarColor: "#FF5722", bio: "Promoted at work, stable housing, living my best life." },
    { email: "sarah@sjp.demo", password: hash, firstName: "Sarah", lastName: "Chen", role: "staff" as const, stage: "client" as const, graduationDate: null, avatarColor: "#607D8B", bio: "Community coordinator. Here to support your journey." },
    { email: "james@sjp.demo", password: hash, firstName: "James", lastName: "Wright", role: "staff" as const, stage: "client" as const, graduationDate: null, avatarColor: "#795548", bio: "Case manager. Your success is my success." },
    { email: "broc@sjp.demo", password: hash, firstName: "Broc", lastName: "Thompson", role: "staff" as const, stage: "client" as const, graduationDate: null, avatarColor: "#3F51B5", bio: "Program staff. Let's build something together." },
    { email: "scott@sjp.demo", password: hash, firstName: "Scott", lastName: "Richards", role: "admin" as const, stage: "alumni" as const, graduationDate: null, avatarColor: "#009688", bio: "CEO. Proud of every woman who walks through our doors." },
    { email: "quinta@sjp.demo", password: hash, firstName: "Quinta", lastName: "Adams", role: "admin" as const, stage: "alumni" as const, graduationDate: null, avatarColor: "#F44336", bio: "Program lead. This community is everything." },
  ];
  ...
  const postData = [
    ...
    { authorId: createdUsers.monica, content: "One year at Golden 1 Center today. One year of showing up, doing good work, and building something real. SJP gave me the foundation — I built the house.", postType: "milestone" as const, pinned: false, createdAt: daysAgo(3) },
