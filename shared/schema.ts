...
import { pgTable, text, uuid, timestamp, boolean, integer, date, time, pgEnum } from "drizzle-orm/pg-core";
...
export const approvalStatusEnum = pgEnum("approval_status", ["pending", "approved", "community_only"]);
