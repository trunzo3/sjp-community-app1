...
export async function seedDatabase() {
  ...
  const seedUsers = [
    { email: "angela@sjp.demo", password: hash, firstName: "Angela", lastName: "Torres", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#34737A", bio: "Just started at Gateway. Taking it one day at a time.", photoUrl: "/uploads/avatars/angela.jpg" },
    { email: "keisha@sjp.demo", password: hash, firstName: "Keisha", lastName: "Williams", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#5DA592", bio: "Two weeks in. Already learning so much.", photoUrl: "/uploads/avatars/keisha.webp" },
    { email: "destiny@sjp.demo", password: hash, firstName: "Destiny", lastName: "Johnson", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#D32027", bio: "Working on my future every day. Moved to OSS last month.", photoUrl: "/uploads/avatars/destiny.webp" },
    { email: "maria@sjp.demo", password: hash, firstName: "Maria", lastName: "Garcia", role: "client" as const, stage: "client" as const, graduationDate: null, avatarColor: "#979DB6", bio: "Kitchen team and loving it. Getting ready for what's next.", photoUrl: "/uploads/avatars/maria.jpg" },
    { email: "monica@sjp.demo", password: hash, firstName: "Monica", lastName: "Davis", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(monicaGrad), avatarColor: "#EEBBA7", bio: "Working full-time at Golden 1 Center. My kids are home with me.", photoUrl: "/uploads/avatars/monica.jpg" },
    { email: "tasha@sjp.demo", password: hash, firstName: "Tasha", lastName: "Robinson", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(tashaGrad), avatarColor: "#34737A", bio: "Just started my new customer service role. Grateful every day.", photoUrl: "/uploads/avatars/tasha.jpg" },
    { email: "denise@sjp.demo", password: hash, firstName: "Denise", lastName: "Mitchell", role: "alumni" as const, stage: "alumni" as const, graduationDate: dateStr(deniseGrad), avatarColor: "#5DA592", bio: "Promoted at work, stable housing, living my best life.", photoUrl: "/uploads/avatars/denise.jpg" },
    { email: "sarah@sjp.demo", password: hash, firstName: "Sarah", lastName: "Chen", role: "staff" as const, stage: "client" as const, graduationDate: null, avatarColor: "#D32027", bio: "Community coordinator. Here to support your journey.", photoUrl: "/uploads/avatars/sarah.jpg" },
    ...
    { email: "quinta@sjp.demo", password: hash, firstName: "Quinta", lastName: "Adams", role: "admin" as const, stage: "alumni" as const, graduationDate: null, avatarColor: "#D32027", bio: "Program lead. This community is everything.", photoUrl: "/uploads/avatars/quinta.webp" },
  ];
